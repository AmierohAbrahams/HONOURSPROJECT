...
After the sites were matched the distance was converted to radians the siteswere matched with the sites of the 10year time series. Hereafter the wave data was combined with the temperature data at a depth of 7 and 15m respectivley. 
