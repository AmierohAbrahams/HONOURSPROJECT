...
The results indicate that wind speed, wind height, wind and wave direction as well as wave period had no significant impact on temperature variation at the various sites along the coastline. Eastern Beach however shows that wave period and wave height appear to have the largest effect on temperature variation. Hamburg and Gordons show that wave direction have a 4% influence on temperature variation. Muizenberg, representing the largest value of 5% influence of wave height on temperature variation. Predominant wind and wave direction have no significant impact on the seawater temperature variation along the coast.
