...
****Still need to add in some things on the distances between sites, fix boxplot appearance****



******Discussing the mean-average_temper_per_month, fix plot appearance*****
```{r}
